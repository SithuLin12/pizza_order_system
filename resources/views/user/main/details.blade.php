    ...
    <div class="container-fluid pb-5">
        <div class="row px-xl-5">
            <div class="col-lg-5 mb-30">
                <a href="{{ route('user#home') }}" class="text-decoration-none text-black">
                ...
                <div id="product-carousel" class="carousel slide mt-3" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="{{ asset('storage/' . $pizza->image) }}">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-7 h-auto mb-30 mt-3">
                <div class="h-100 bg-light p-30">
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        ...
                        <button type="button" class="btn btn-primary px-3" id="addCart"><i
...
@section('scriptSource')
    <script>
        $(document).ready(function() {
            ...
            $.ajax({
                type: "get",
                url: "http://localhost:8000/user/ajax/increaseViewCount",
